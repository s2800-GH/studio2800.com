...
- Follow-up documentation commits: pushed after the refresh so the health notes, setup notes, official links, and PDF manual describe the current GitHub backup state.
